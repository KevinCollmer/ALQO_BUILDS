...
public:
    ...
    QLabel *wallet_customzXLQbackuppath_label;
    QLabel *wallet_customzXLQbackuppath;
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        wallet_customzXLQbackuppath_label = new QLabel(tab_repair);
        wallet_customzXLQbackuppath_label->setObjectName(QStringLiteral("wallet_customzXLQbackuppath_label"));
        wallet_customzXLQbackuppath_label->setVisible(false);

        gridLayout_4->addWidget(wallet_customzXLQbackuppath_label, 4, 0, 1, 1);

        wallet_customzXLQbackuppath = new QLabel(tab_repair);
        wallet_customzXLQbackuppath->setObjectName(QStringLiteral("wallet_customzXLQbackuppath"));
        wallet_customzXLQbackuppath->setCursor(QCursor(Qt::IBeamCursor));
        wallet_customzXLQbackuppath->setTextFormat(Qt::PlainText);
        wallet_customzXLQbackuppath->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);
        wallet_customzXLQbackuppath->setVisible(false);

        gridLayout_4->addWidget(wallet_customzXLQbackuppath, 4, 1, 1, 3);
    ...
    void retranslateUi(QDialog *RPCConsole)
    {
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the ALQO debug log file from the current data directory. This can take a few seconds for large log files.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        wallet_customzXLQbackuppath_label->setText(QApplication::translate("RPCConsole", "Custom zXLQ Backup Path:", Q_NULLPTR));
        wallet_customzXLQbackuppath->setText(QApplication::translate("RPCConsole", "N/A", Q_NULLPTR));
