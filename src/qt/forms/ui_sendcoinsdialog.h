...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 XLQ"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 XLQ"));
        ...
        checkHyperSend = new QCheckBox(frameFee);
        checkHyperSend->setObjectName(QStringLiteral("checkHyperSend"));
        checkHyperSend->setEnabled(true);
        checkHyperSend->setMinimumSize(QSize(85, 0));

        horizontalLayoutFee9->addWidget(checkHyperSend);
        ...
        checkzXLQ = new QCheckBox(frame_Send);
        checkzXLQ->setObjectName(QStringLiteral("checkzXLQ"));
        checkzXLQ->setEnabled(false);

        horizontalLayout_2->addWidget(checkzXLQ);
        ...
        labelBalance->setText(QStringLiteral("123.456 XLQ"));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelBlockSize->setText(QApplication::translate("SendCoinsDialog", "0 XLQ", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        checkHyperSend->setToolTip(QApplication::translate("SendCoinsDialog", "HyperSend technology allows for near instant transactions - A flat fee of 0.01 XLQ applies", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkHyperSend->setText(QApplication::translate("SendCoinsDialog", "HyperSend", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        radioCustomPerKilobyte->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 uXLQs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uXLQs in fee,<br />while \"at least\" pays 1000 uXLQs. For transactions bigger than a kilobyte both pay by kilobyte.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        radioCustomPerKilobyte->setText(QApplication::translate("SendCoinsDialog", "per kilobyte", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        radioCustomAtLeast->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 uXLQs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uXLQs in fee,<br />while \"total at least\" pays 1000 uXLQs. For transactions bigger than a kilobyte both pay by kilobyte.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        radioCustomAtLeast->setText(QApplication::translate("SendCoinsDialog", "total at least", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for ALQO transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for ALQO transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        checkzXLQ->setText(QApplication::translate("SendCoinsDialog", "Anonymized XLQ", Q_NULLPTR));
