...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start ALQO after logging in to the system.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start ALQO on system login", Q_NULLPTR));
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        checkBoxZeromintEnable->setToolTip(QApplication::translate("OptionsDialog", "Enable automatic minting of XLQ units to zXLQ", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxZeromintEnable->setText(QApplication::translate("OptionsDialog", "Enable zXLQ Automint", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        percentage_label->setToolTip(QApplication::translate("OptionsDialog", "Percentage of incoming XLQ which get automatically converted to zXLQ via Zerocoin Protocol (min: 10%)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        percentage_label->setText(QApplication::translate("OptionsDialog", "Percentage of autominted zXLQ", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        labelPreferredDenom->setToolTip(QApplication::translate("OptionsDialog", "Wait with automatic conversion to Zerocoin until enough XLQ for this denomination is available", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        labelPreferredDenom->setText(QApplication::translate("OptionsDialog", "Preferred Automint zXLQ Denomination", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        preferredDenom->setToolTip(QApplication::translate("OptionsDialog", "Wait with automatic conversion to Zerocoin until enough XLQ for this denomination is available", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the ALQO client port on the router. This only works when your router supports UPnP and it is enabled.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the ALQO network through a SOCKS5 proxy.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting ALQO.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/alqo-project/alqo-project-translations", Q_NULLPTR));
