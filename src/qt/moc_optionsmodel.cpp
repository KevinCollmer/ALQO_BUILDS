...
QT_MOC_LITERAL(7, 108, 26), // "anonymizeALQOAmountChanged"
...
QT_MOC_LITERAL(9, 162, 23) // "hideZeroBalancesChanged"
    ...
    "preferredDenomChanged\0anonymizeALQOAmountChanged\0"
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->anonymizeALQOAmountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (OptionsModel::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsModel::anonymizeALQOAmountChanged)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 4
void OptionsModel::anonymizeALQOAmountChanged(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
